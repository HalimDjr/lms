  ...
  return (
    <div className="flex w-full items-start gap-x-6">
      <div className="flex flex-1 flex-col">
        <h1
          className={`mb-14 text-3xl font-medium text-center sm:text-left ${
        ...
        {loading ? (
          ...
          <div className="flex-1">
            {course ? (
              ...
              <p
                className={`mt-14 text-center text-3xl font-semibold ${
                  darkMode ? "text-richblack-100" : "text-richblack-500"
                }`}
              >
                Formation not found
              </p>
      ...
      {/* <div className={`sticky top-10 hidden lg:block max-w-[400px] flex-1 rounded-md border-[1px] p-6 ${
        darkMode 
          ? "border-richblack-700 bg-richblack-800" 
          : "border-richblack-200 bg-white shadow-sm"
      }`}>
